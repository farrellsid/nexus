...
**Status, 2026-09-24: plan drafted, not started.** `docs/superpowers/plans/2026-09-24-m5-visual-shell.md` measures the reference (640 JS files, 327 upstream tests, 13.6 MB of bundled data, 286 KB of CSS, plain JavaScript, Google CDN fonts) and lays out the import, 16 strip steps, the Nexus additions and the exit checks. It asks four decisions of the user: how strip steps are recorded, JavaScript versus TypeScript, imagery in local development, and which effects stay.
