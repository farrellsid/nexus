# Investigation 02 — Oil under constraint
...
The fixture contains 20 reviewed public source records, 23 entities, 26 source-checked candidate assertions, 8 developments, 11 metric groups and 14 authored acceptance cases. Most quantitative claims still rely on EIA analysis; IEA's Oil Market Report and India's PPAC now add source diversity beyond EIA. JODI is retained to establish the common data cutoff but its bulk dataset has not yet been integrated. Geographic geometry beyond the existing guided stops/routes remains a later research step.

All records remain candidates until reviewed in Nexus. Passing schema or UI checks does not independently verify the underlying reports.
